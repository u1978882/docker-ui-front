...
<section>
	...
	<div class="flex mb-2">
		...
		<div class="">
			<button on:click={() => {modalNewVolume(servidor)}} type="button" class="btn variant-filled-primary mb-4 p-2 mr-3">
				<span>
		...
		<div class="">
			<button on:click={() => {llistaVolums(servidor)}} type="button" class="btn variant-filled-primary mb-4 p-2">
				{#if loading}
...
<script>
	...
	function modalNewVolume(servidor) {
		const modal = {
			type: 'prompt',
			// Data
